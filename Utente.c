...
int Esiste_Nome_Utente(char nome_utente[], int ver){
...
int Esiste_Paswd_Utente(char paswd[], char nome_utente[], int ve){
    FILE *fp = fopen("passwd.txt","r");
...
int accedi(int verifica, char nome_ut[]){
    char paswd[30];
    int  c = 0;
    do{
        printf("Inserisci Password:");
        *paswd = nascondi_pass(paswd);
        c = Esiste_Paswd_Utente(paswd, nome_ut, c);
        if(c != 2){
            printf("\n\n==============================\n");
            SetColor(4);
